        ...
        function drawEvents($calendarElement, type) {
            ...
            if (events !== false) {
                $(events).each(function (index, value) {
                    ...
                    if (parseInt(value.date[8], 10) === 0) {
                    $dayElement.html(value.date[9] +'<p>' + value.desc + '</p>');
                                           // $dayElement.html(value.date[8] + value.date[9] +'<p>test</p>');
                    } else {
                    $dayElement.html(value.date[8] + value.date[9] +'<p>' + value.desc + '</p>');
